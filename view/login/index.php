...
<head>
    ...
    <title>Control Pymes Costa Rica, todos los derechos reservados - Mas Informacion: 8690-2789</title>
    <link href='assets/img/CP.ico' rel='shortcut icon' type='image/x-icon'/>
    ...
    <div class="middle-box text-center loginscreen animated fadeInDown">
        <div>
            <div class="ibox-content">
                <center><img src="assets/img/logo_01.png"/></center>
            </div>
                ...
                <form class="m-t" id="frm-login" role="form" method="post" action="controller/login.controller.php" autocomplete="off">
                    <div class="form-group">
                        <select class="selectpicker show-tick form-control cb_tpuser" id="cb_tpuser" name="txt_rol"  data-live-search-style="begins" data-live-search="true" title="Seleccionar Rol de Usuario" autocomplete="off">
                            <option value="1" title="Rol: ADMINISTRADOR">ADMINISTRADOR</option>
                            <option value="2" title="Rol: CAJA">CAJA</option>
                            <option value="3" title="Rol: COCINA">COCINA</option>
                            <option value="4" title="Rol: MESERO">MESERO</option>
                          </select>
                    </div>
                    <div class="opc1">
                        <div class="form-group">
