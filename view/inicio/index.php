...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-6">
        <h2><i class="fa fa-cutlery"></i> <a class="a-c" href="inicio.php">Restaurante</a></h2>
        <ol class="breadcrumb">
            <li class="active">
                <strong>Mesas</strong>
            </li>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="nomb_cliente" class="form-control" placeholder="Ingrese nombre cliente" value="Público General" autocomplete="off" required="required"/>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label class="control-label">Nombre Mesero</label>
                            <select name="cod_mozo" id="cod_mozo" class="selectpicker show-tick form-control" data-live-search="true" autocomplete="off" title="Seleccionar Mesero" required="" data-size="5">
